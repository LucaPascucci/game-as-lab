...
import rollball6_game_over.physics.BoundaryCollision;
...
public class World {
	...
	public Optional<GameObject> checkCollisionWithPickableObj(P2d pos, CircleBoundingBox box){
	...
	public List<GameObject> getPickUpObjs(){
		return picks;
	}
